<template>
  <div>
                            ...
                            <div class="form-group row the-end-custom">
                                ...
                                <div class="col-lg-6">
                                    <label class="col-sm-7 col-form-label"> Your fingerprint:
                                            <div class="tooltipCustom is-hidden">
                                                <sup>
      ...
      <!-- MOBILE -->
      <div class="div-only-mobile-ipad is-hidden">
          <div class="row row-mobile">
            <p class="col-lg-6">Please, use <strong>desktop</strong> to access this site.</p>
            <!-- <p class="col-lg-6">access this site.</p> -->
          </div>
          <div class="col-lg-6">
            <img alt="elf-image" src="../assets/images/elf-image-mobile.png" class="elf-image-mobile">
          </div>
      </div>
  </div>
</template>
...
Fixed bootstrap layout problem thanks to 
https://stackoverflow.com/questions/51099397/printing-breaks-bootstrap-layout/51209031
explanation   */
@media print {
    @page {
        size: A4 !important;
